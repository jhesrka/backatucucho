export class UpdateUserAdminDTO {
  ...
  static create(data: any): [string[]?, UpdateUserAdminDTO?] {
    const errors: string[] = [];
    ...
    if ("surname" in data) dto.surname = data.surname;
    if ("birthday" in data) dto.birthday = data.birthday;
    if ("email" in data) dto.email = data.email;
    if ("whatsapp" in data) dto.whatsapp = data.whatsapp;
