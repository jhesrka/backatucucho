...
export class PedidoUsuarioService {
  ...
  async crearPedido(dto: CreatePedidoDTO) {
    ...
    if (horaCierreEfectiva && tiempoEstimadoFinStr > horaCierreEfectiva && tiempoEstimadoFinStr < "23:59:59") {
      throw CustomError.badRequest(`El tiempo de preparación (${maxPrep} min) supera nuestra hora de cierre (${horaCierreEfectiva.substring(0,5)}). Por favor, haz tu pedido con más anticipación.`);
    }
    // -----------------------------------------------------
