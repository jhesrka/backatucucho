...
class UseradminController {
    constructor(useradminService) {
        ...
        this.checkSetupStatus = (req, res) => {
            this.useradminService
                .checkSetupStatus()
                .then((data) => res.status(200).json(data))
                .catch((error) => this.handleError(error, res));
        };
        this.setupFirstAdmin = (req, res) => {
            const _a = req.body, { masterPin } = _a, adminData = __rest(_a, ["masterPin"]);
            const [error, createUseradminDto] = domain_1.CreateUseradminDTO.create(adminData);
            if (error)
        ...
        this.loginAdmin = (req, res) => {
            ...
            const bodyWithMetadata = Object.assign(Object.assign({}, req.body), { ip, userAgent });
            const [error, loginAdminUserDto] = domain_1.LoginAdminUserDTO.create(bodyWithMetadata);
            if (error)
