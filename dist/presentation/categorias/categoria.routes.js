...
class CategoriaRoutes {
    static get routes() {
        ...
        // ====================== ADMIN ======================
        // Crear categoría
        router.post("/", [auth_admin_middleware_1.AuthAdminMiddleware.protect, (0, upload_files_adapter_1.uploadFields)([{ name: "imagen", maxCount: 1 }, { name: "coverImage", maxCount: 1 }])], categoriaController.createCategoria);
        // Actualizar categoría
        router.patch("/:id", [auth_admin_middleware_1.AuthAdminMiddleware.protect, (0, upload_files_adapter_1.uploadFields)([{ name: "imagen", maxCount: 1 }, { name: "coverImage", maxCount: 1 }])], categoriaController.updateCategoria);
        // Eliminar categoría
